...
function changeLang(lang) {
    ...
    if(lang == 'ar'){
            document.getElementById('lnagLink').setAttribute('href', 'assets/css/rtl.css');
            document.getElementById('bootstp').setAttribute('href', 'assets/css/bootstrap-rtl.min.css');
    }else if(lang == 'en'){
            document.getElementById('lnagLink').setAttribute('href', 'assets/css/style.css');
            document.getElementById('bootstp').setAttribute('href', 'assets/css/bootstrap.min.css');
    }
}
